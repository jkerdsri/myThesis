...
\problemAnswer{ % Answer
In our implementation, the Rendezvous node can move with the \texbf{Sweep mechanism} to gain more chance of meeting the node with less transmission radio range.
%%
