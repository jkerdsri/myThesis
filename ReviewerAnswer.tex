...
\newcommand{\hmwkAuthorName}{Dynamic Rendezvous based Routing Algorithm on Sparse Opportunistic Network Environment} % Your name
...
% [Question \#\arabic{homeworkProblemCounter}]

\begin{homeworkSection}{[Question \#\arabic{homeworkProblemCounter}]} % Section within problem
